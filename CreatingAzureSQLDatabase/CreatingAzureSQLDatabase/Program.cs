...
namespace CreatingAzureSQLDatabase
{
    class Program
    {
        //*************************************************************************************************************
        ...
        static void Main(string[] args)
        {
            ...
            {
                PublishSettingsFilePath = @"Here your file.publishsettings", // UPDATE
                ServerRegion = "West US",
                ServerAdminUsername = "Your_admin_user_name", // UPDATE
                ServerAdminPassword = "Your_Password", // UPDATE
